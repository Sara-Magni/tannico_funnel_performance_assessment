...
[![Tannico Dashboard Preview](images/dashboard_1.png)](https://public.tableau.com/app/profile/sara.m4gn1/viz/TannicoE-commercePeakSeasonStrategicPerformance/Dashboard_p1)
...
## Strategic Evolution: Bridging Data & UX
*While this project focuses on quantitative performance, its real-world impact would be amplified by integrating UX research methodologies to move from descriptive to diagnostic analytics:*

* **Sentiment & Review Mining:** By cross-referencing sales performance with customer review sentiment, I could identify whether a sales drop in specific categories (e.g., Sparkling Wines) is due to a product-market fit issue or a shift in consumer expectations.
* **Qualitative Feedback (CSAT/NPS):** Correlating user satisfaction scores with repurchase patterns (Retention) would allow for predicting churn risk in the "Italy Desktop" segment before it impacts the bottom line.
* **Behavioral Navigation Insights:** Overlaying conversion funnel data with usability feedback (e.g., session recordings) would help distinguish between price-sensitive drop-offs at the $70 threshold and friction caused by UI/UX issues in the mobile checkout flow.
